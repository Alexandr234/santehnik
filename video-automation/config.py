...
# Папка с несколькими вашими фото (анфас, полуоборот, разный свет).
# Если она есть и не пуста — берутся снимки оттуда (до 4 шт.), и лицо
# получается заметно точнее, чем с одного фото.
FACE_DIR = BASE_DIR / "ЛИЦО"
