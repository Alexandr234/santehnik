...
def generate_prompts(
    ...
    blocks: list[VisualBlock],
    lang_code: str,
    batch_size: int = DEFAULT_PROMPT_BATCH_SIZE,
...
def process_job(
    ...
    rows = generate_prompts(client, blocks, job.language_code, batch_size=batch_size, workers=workers)
...
def main() -> None:
    ...
    for job in jobs:
        process_job(client, job, root_dir,
                    ...
                    workers=args.prompt_workers, batch_size=args.prompt_batch_size)
